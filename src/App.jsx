  ...
  return (
    <div className="app-root">
      ...
      <main className="app-main">
        ...
        <section
          className={`results-area${calculating ? " results-calculating" : ""}`}
        >
          {calculating && best && (
          ...
          {!best ? (
            <div className="empty-state">
              ...
              <p>
                Enter your race parameters and click{" "}
      ...
      <footer className="app-footer">
        GT7 Strategy Calculator · All calculations are estimates. Verify with
        in-game data.
      </footer>
    </div>
  );
