...
![Tests](https://img.shields.io/badge/tests-2020%20assertions%20passing-FFD700?style=flat-square&logoColor=black)
...
| `npm test` | Full test suite — 2 020 assertions |
...
```bash
npm test              # 2 020 assertions across twelve suites
...
| **Stint log** | `tests/test_stint_log.js` | 19 | Drivers-tab bookkeeping — stint open/close, per-lap average/best/worst folding, compound sync, driver (re)assignment |
