...
![Tests](https://img.shields.io/badge/tests-2057%20assertions%20passing-FFD700?style=flat-square&logoColor=black)
...
| `npm test` | Full test suite — 2 057 assertions |
...
```bash
npm test              # 2 057 assertions across thirteen suites
...
| **Teams** | `tests/test_teams.js` | 27 | Multi-car display — stable per-team colour across pruning, first-seen ordering, staleness dropout |
