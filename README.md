...
![Tests](https://img.shields.io/badge/tests-2075%20assertions%20passing-FFD700?style=flat-square&logoColor=black)
...
| `npm test` | Full test suite — 2 075 assertions |
...
```bash
npm test              # 2 075 assertions across thirteen suites
