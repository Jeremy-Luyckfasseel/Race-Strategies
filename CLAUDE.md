...
npm test             # All 49 suites (~3 226 assertions). Judge by EXIT CODE, not output.
...
| `tests/test_comprehensive.js` | The engine's own suite (~142 assertions). The full list of all 49 suites, and what each one guards, is in `docs/CURRENT_STATE.md` §2 |
